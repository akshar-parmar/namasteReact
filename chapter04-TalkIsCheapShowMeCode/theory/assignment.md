...
[![VDOM.png](https://i.postimg.cc/NM8kQcKt/VDOM.png)](https://postimg.cc/JDnkQS3Y)

source : https://dev.to/ridhamz/the-reconciliation-algorithm-5bab
...
function App() {
  return (
    <div className="App">
      <Tool name="Akshar" tool="Figma"/> // name and tool are props
    </div>
  )
}
```
Here Tool is a functional Component and name , tool are jsx attributes that are passed as an argument to Tool Component.
